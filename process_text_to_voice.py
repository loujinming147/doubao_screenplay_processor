...
def parse_args():
    ...
    parser.add_argument("--text_file", type=str, default="assets/美食-武则天测试(1).md", help="输入的 TEXT 文件路径")
    parser.add_argument("--output_dir", type=str, default="output/wuzetian", help="输出目录路径")
