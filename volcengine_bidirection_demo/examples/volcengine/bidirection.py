...
if __name__ == "__main__":
    asyncio.run(main())
# python3 volcengine_bidirection_demo/examples/volcengine/bidirection.py --appid 7913609641 --access_token teLzt62B8gRhfKVOqAbEpiCgDl1Jxcjq --voice_type seed-tts-2.0 --text "你好，我是火山引擎的语音合成服务。这是一个美好的旅程。" 
